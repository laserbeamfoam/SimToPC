...
slice1.SliceType.Origin = [(DOMAIN_SIZE_IN_MICRONS[0]/2)*(1e-6), 0.0004000000117230229, 0.00011124939192086458]
...
slice1Display.ScaleFactor = 5.200000159675256e-05
...
slice1Display.GaussianRadius = 2.6000000798376276e-06
...
# init the 'PiecewiseFunction' selected for 'ScaleTransferFunction'
slice1Display.ScaleTransferFunction.Points = [54424.359375, 0.0, 0.5, 0.0, 166108.765625, 1.0, 0.5, 0.0]
slice1Display.ScaleTransferFunction.UseLogScale = 0

# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
slice1Display.OpacityTransferFunction.Points = [54424.359375, 0.0, 0.5, 0.0, 166108.765625, 1.0, 0.5, 0.0]
...
# current camera placement for renderView1
renderView1.CameraPosition = [0.0006432734172712611, 0.0004000000044470653, 0.00011124939192086458]
renderView1.CameraFocalPoint = [9.50010162341641e-05, 0.0004000000044470653, 0.00011124939192086458]
renderView1.CameraViewUp = [0.0, 0.0, 1.0]
renderView1.CameraParallelScale = 0.00036806071635290275

# save screenshot
SaveScreenshot('./y_z_slice_meltpool.png', layout1, ImageResolution=[1980, 907],
    FontScaling='Scale fonts proportionally',
    OverrideColorPalette='',
    StereoMode='No change',
    TransparentBackground=0, 
