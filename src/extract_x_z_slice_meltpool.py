...
# save screenshot
SaveScreenshot('./Cip1.png', layout1, ImageResolution=[1980, 907],
...
slice1Display.ScaleFactor = 6.5159190853592015e-06
...
slice1Display.GaussianRadius = 3.2579595426796004e-07
...
# init the 'PiecewiseFunction' selected for 'ScaleTransferFunction'
slice1Display.ScaleTransferFunction.Points = [-2275.870361328125, 0.0, 0.5, 0.0, 178722.34375, 1.0, 0.5, 0.0]
slice1Display.ScaleTransferFunction.UseLogScale = 0

# init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
slice1Display.OpacityTransferFunction.Points = [-2275.870361328125, 0.0, 0.5, 0.0, 178722.34375, 1.0, 0.5, 0.0]
...
# current camera placement for renderView1
renderView1.CameraPosition = [9.500101987214293e-05, 0.00021623814904774184, 0.00011124939192086458]
renderView1.CameraFocalPoint = [9.500101987214293e-05, 0.0004000000117230229, 0.00011124939192086458]
renderView1.CameraViewUp = [0.0, 0.0, 1.0]
renderView1.CameraParallelScale = 0.0003199670948300029

# save screenshot
SaveScreenshot('./x_z_slice_meltpool.png', layout1, ImageResolution=[1980, 907],
    FontScaling='Scale fonts proportionally',
    OverrideColorPalette='',
    StereoMode='No change',
    TransparentBackground=0, 
...
# export view
ExportView('./x_z_slice_meltpool.csv', view=spreadSheetView1)
