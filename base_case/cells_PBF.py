...
domain_size = (240, 780, 300) #(200, 800, 200)  # Size of the domain  domain_size = (X, Y, Z) [ micrometers ]
number_of_cells_x = 80  #  Number of cells in the x direciton, the number of cells in y and z direction will be calculated so the cells are perfect squares 

#  The total number of processors that will be used to parallelize the domain
total_num_of_processors = 80 
